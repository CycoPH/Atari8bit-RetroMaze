...
@if %errorlevel% neq 255 goto error

c:\progs\cc65\bin\cl65 --debug-info -Wl --dbgfile,"out\retromaz.dbg" --lib-path C:\progs\cc65\lib -C atari.cfg -t atari -T -Cl -Oirs -O -vm -v --mapfile retromaze.map -l a.txt -o out\main.xex maze65.c hall.c maze_generator.c draw_map.c map_gui.c asm\ataristd.s

@if %errorlevel% neq 0 goto error
bin\joinxex out/boot_part1.xex out/boot_part2.xex out/fixed.xex out/main.xex -j -oout/retromaz.xex
::bin\merge-xex out/fixed.xex out/main.xex out/maze65.xex
goto end
:error
pause
exit /b %errorlevel%
:end
start out\maze65.xex

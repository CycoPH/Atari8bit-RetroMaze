...
c:\progs\cc65\bin\cl65 -Ln retromaze.lbl --lib-path C:\progs\cc65\lib -C ./atari.cfg -t atari -T -Cl -Oirs -O -vm -v --mapfile maze65.map -l a.txt -o out\main.xex maze65.c hall.c maze_generator.c draw_map.c map_gui.c asm\ataristd.s
